...
/** This command allows a server to remove a managed app. This command will fail for apps that are managed by Declarative Device Management.
 *
 * - iOS:
 *    - introduced: 5.0
 ...
 *    - supervised: false
 */
export const RemoveApplicationPayload = z.object({
