 ...
 *    - introduced: n/a
 */
export type RotateFileVaultKeyPayload = {
    ...
    FileVaultUnlock: {
         ...
         *    - deprecated: 10.15
         */
        PrivateKeyExport: string | undefined;
         ...
         *    - deprecated: 10.15
         */
        PrivateKeyExportPassword: string | undefined;
    };
    ...
    NewCertificate: string | undefined;
    ...
    ReplyEncryptionCertificate: string | undefined;
};
 ...
 *    - introduced: n/a
 */
export type RotateFileVaultKeyResponse = {
